...
Email: Baskaran.avinash @gmail.com}
}
...
\begin{abstract}
  ...
  The Gluss-Con a hand-held device, with a data collection, processing and wireless
  ...
  Gluss-con is capable of adopting a set of fixed configurations which proportionally corresponds to the Gluss, allowing it to control
