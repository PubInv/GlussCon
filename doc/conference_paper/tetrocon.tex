...
By utilizing a 3D-printed jointing system
 ...
 extending previously patented work \cite{song2003spherical} and small-scale
 ...
 condition is achieved by attaching rods only to cables, not other rods.
  ...
  However, \cite{HamlinSandersonCMS} produced a novel concentric
 ...
 Somewhat later
 \cite{song2003spherical} patented a modification of a ball-and-socket
...
\end{table}
 ...
 is available on our site \cite{tetrobotplayground}.
